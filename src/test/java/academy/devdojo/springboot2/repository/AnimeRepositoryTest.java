...
class AnimeRepositoryTest {
    ...
    @Test
    @DisplayName("Find By Name returns empty list when anime when is found")
    ...
    @Test
    @DisplayName("Save throw ConstraintValidantionException When name is empty")
    public void save_ThrowsConstraintValidationException_WhenIsEmpty() {
